...
<div class="row-fluid">
  <h3>Microplanta de Biodiesel</h3>                                    
  <ul class="thumbnails">
    <li class="span6">
      <div class="thumbnail">
        <a class="thumbnail" href="<?php echo site_url('alarmas_biodiesel') ?>">
    ...
    <li class="span6">
      <div class="thumbnail">
        <a class="thumbnail" href="<?php echo site_url('reportesBiodiesel') ?>">
...
<div class="row-fluid">
  <ul class="thumbnails">
    <li class="span6">
      <div class="thumbnail">
        <a class="thumbnail" href="<?php echo site_url('graphs_biodiesel') ?>">
