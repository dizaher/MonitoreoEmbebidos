  ...
  <div class="row">
    <div class="col-lg-12" style="margin-top: 10px;">
      ...
      if(!empty($groups))
      {
        ...
        {
          echo '<tr>';
          echo '<td>'.$group->id.'</td><td>'.anchor('admin/users/index/'.$group->name.'</td><td>'.$group->description.'</td><td>'.anchor('admin/groups/edit/'.$group->id,'<span class="glyphicon glyphicon-pencil"></span>');
