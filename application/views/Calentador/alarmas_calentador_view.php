<div class="container">   
<h1 class="text-light-blue">Alarmas Calentador Solar</h1> 
                ...
                <div class="box-body">
                  ...
                  <div class="row">
	                  ...
	                  <div class="form-group">
	                    <label>Alarmas por rangos de fechas</label>
              ...
              <div class="box box-primary">
              	<div class="box-body">              		
              		...
              		if ($results == null) {
	              		...
	              		?>
	              		<a class="btn btn-primary pull-right" href="<?php echo site_url('c_calentador/exportar_alarmas_diarias') ?>"><i class="fa fa-download"></i> Exportar CSV</a>
	              		<?php
	              		}
	              		?>							              		
				    	<table class="table">
				    		<caption>Alarmas del día</caption>
						<tr>
						    <th>Fecha</th>
						    <th>Temp 1</th>
						    <th>Temp 2</th>
