<div class="container">
    <h1 class="text-light-blue">Sistema Acuaponico Chinanpero</h1> 
      ...
      <div class="row">        
        <div class="col-lg-6 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="<?php echo site_url('alarmas_acuaponia') ?>" class="small-box-footer">
        ...
        <div class="col-lg-6 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="<?php echo site_url('graphs_acuaponia') ?>" class="small-box-footer">
                    Consultar <i class="fa fa-arrow-circle-right"></i>
                </a>
            </div>
        </div><!-- ./col -->
